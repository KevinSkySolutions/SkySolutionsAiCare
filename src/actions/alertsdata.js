import { REQUEST_ALERTS, 
    ...
    UPDATE_ALERT_DATA, 
    REQUEST_SENSOR_DATA, 
    RECEIVE_SENSOR_DATA } from '../constants';
...
return { type: UPDATE_ALERT_DATA, payload: { alertid: alertId, updateobject: updateObject, enterpriseId: enterpriseId , description: descriptionString } }
}
